...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/store/history.test.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\nvar _history = __webpack_require__(/*! ../../src/store/history.js */ \"./src/store/history.js\");\n\nvar _hashFrom = __webpack_require__(/*! ../../src/native/hash-from.js */ \"./src/native/hash-from.js\");\n\nvar _hashFrom2 = _interopRequireDefault(_hashFrom);\n\nvar _jsonFrom = __webpack_require__(/*! ../../src/native/json-from.js */ \"./src/native/json-from.js\");\n\nvar _jsonFrom2 = _interopRequireDefault(_jsonFrom);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\ndescribe('store/history', function () {\n  describe('@lctGet(path)', function () {\n    [[undefined, undefined], ['pathname', location.pathname], ['searchString', location.search], ['searchJson', (0, _hashFrom2.default)(location.search, true)], ['hashString', location.hash], ['hashJson', (0, _hashFrom2.default)(location.hash, true)], ['stateString', location.state], ['stateJson', (0, _hashFrom2.default)(location.state, true)]].forEach(function (d) {\n      var path = d[0];\n      it('lctGet(' + path + ') should return ' + (0, _jsonFrom2.default)(d[1]), function () {\n        chai.assert.deepStrictEqual((0, _history.lctGet)(path), d[1]);\n      });\n    });\n  });\n\n  describe('@lctPush(params)', function () {\n    // string\n    it('lctPush(' + location.pathname + '#test=abc) should return true', function () {\n      (0, _history.lctPush)(location.pathname + '#test=abc');\n      chai.assert.deepStrictEqual(function () {\n        return location.hash === '#test=abc';\n      }(), true);\n    });\n    // object\n    it('lctPush({ pathname: \"' + location.pathname + '\", hash: \"#h=123\", search: \"s=abc\" }) should return true', function () {\n      (0, _history.lctPush)({ pathname: location.pathname, hash: '#h=123', search: '?s=abc' });\n      chai.assert.deepStrictEqual(function () {\n        return location.hash === '#h=123' && location.search === '?s=abc';\n      }(), true);\n    });\n  });\n\n  describe('@lctReplace(params)', function () {\n    // string\n    it('lctReplace(' + location.pathname + '#test=123) should return true', function () {\n      (0, _history.lctReplace)(location.pathname + '#test=123');\n      chai.assert.deepStrictEqual(function () {\n        return location.hash === '#test=123';\n      }(), true);\n    });\n    // object\n    it('lctReplace({ pathname: \"' + location.pathname + '\", hash: \"#h=abc\", search: \"s=123\" }) should return true', function () {\n      (0, _history.lctReplace)({ pathname: location.pathname, hash: '#h=abc&h2=def', search: '?s=123&s2=456' });\n      chai.assert.deepStrictEqual(function () {\n        return location.hash === '#h=abc&h2=def' && location.search === '?s=123&s2=456';\n      }(), true);\n    });\n  });\n\n  describe('@lctQuery(excepts)', function () {\n    it('lctQuery() should return ' + location.search + location.hash, function () {\n      chai.assert.deepStrictEqual((0, _history.lctQuery)(), '' + location.search + location.hash);\n    });\n  });\n});\n\n//# sourceURL=webpack:///./test/store/history.test.js?");
