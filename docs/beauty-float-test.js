...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/number/beauty-float.test.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./test/number/beauty-float.test.js":
/*!******************************************!*\
  !*** ./test/number/beauty-float.test.js ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar beautyFloat = __webpack_require__(/*! ../../src/number/beauty-float.js */ \"./src/number/beauty-float.js\");\n\ndescribe('number/beauty-float', function () {\n  describe('@beautyFloat(n, count, noZero)', function () {\n    [\n    // 参数: n\n    [undefined, undefined, undefined, '0'], ['', undefined, undefined, '0'], ['123456.78', undefined, undefined, '123,456.78'], ['1-23456.78', undefined, undefined, '0'], [123456.78, undefined, undefined, '123,456.78'], [123456, undefined, undefined, '123,456'], [0.78, undefined, undefined, '0.78'], [0, undefined, undefined, '0'],\n    // 参数: count\n    [0, undefined, undefined, '0'], [0.1, 2, undefined, '0.1'], [0.1, 2, undefined, '0.1'], [0.123, 2, undefined, '0.12'],\n    // 参数: noZero\n    [123, undefined, true, '123'], [0, undefined, true, ''], [0, undefined, false, '0']].forEach(function (d) {\n      var n = d[0];\n      var count = d[1];\n      var noZero = d[2];\n      it('beautyFloat(' + n + ', ' + count + ', ' + noZero + ') should return ' + d[3], function () {\n        chai.assert.strictEqual(beautyFloat.default(n, count, noZero), d[3]);\n      });\n    });\n  });\n});\n\n//# sourceURL=webpack:///./test/number/beauty-float.test.js?");
