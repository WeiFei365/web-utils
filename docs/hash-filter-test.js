...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/native/hash-filter.test.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./test/native/hash-filter.test.js":
/*!*****************************************!*\
  !*** ./test/native/hash-filter.test.js ***!
  \*****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar hashFilter = __webpack_require__(/*! ../../src/native/hash-filter.js */ \"./src/native/hash-filter.js\");\n\ndescribe('native/hash-filter', function () {\n  describe('@hashFilter(any, excepts)', function () {\n    [\n    // 数据合法性\n    [undefined, undefined, ''], ['', undefined, ''], [undefined, ['haha'], ''], ['', ['haha'], ''],\n    // search\n    ['?test=abc', undefined, 'test=abc'], ['?test=abc&pms=123', ['pms'], 'test=abc'],\n    // hash\n    ['#test=abc', undefined, 'test=abc'], ['#test=abc&pms=123', ['pms'], 'test=abc'],\n    // search + hash 混合\n    ['?pms=123#test=abc', undefined, 'pms=123&test=abc'], ['#test=abc?pms=123', ['pms'], 'test=abc']].forEach(function (d) {\n      var any = d[0];\n      var excepts = d[1];\n      it('hashFilter(' + any + ', ' + excepts + ') should return ' + d[2], function () {\n        chai.assert.strictEqual(hashFilter.default(any, excepts), d[2]);\n      });\n    });\n  });\n});\n\n//# sourceURL=webpack:///./test/native/hash-filter.test.js?");
