...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/store/lstore-db-search_words.test.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/store/lstore-db-search_words.js":
/*!*********************************************!*\
  !*** ./src/store/lstore-db-search_words.js ***!
  \*********************************************/
/*! no static exports found */
...
/***/ "./test/store/lstore-db-search_words.test.js":
/*!***************************************************!*\
  !*** ./test/store/lstore-db-search_words.test.js ***!
  \***************************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar _lstoreDbSearch_words = __webpack_require__(/*! ../../src/store/lstore-db-search_words.js */ \"./src/store/lstore-db-search_words.js\");\n\nvar _lstoreDbSearch_words2 = _interopRequireDefault(_lstoreDbSearch_words);\n\nvar _jsonFrom = __webpack_require__(/*! ../../src/native/json-from.js */ \"./src/native/json-from.js\");\n\nvar _jsonFrom2 = _interopRequireDefault(_jsonFrom);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\ndescribe('store/lstore-db-search_words', function () {\n  describe('@searchWords.add(data)', function () {\n    [[undefined, []], ['', []], [false, []], [0, []], ['01', [{ data: '01' }]], [undefined, [{ data: '01' }]], ['02', [{ data: '02' }]], ['  02   ', [{ data: '02' }]], ['  03   ', [{ data: '03' }]], ['这是一段话，可能被高亮，也可能不，但是可以试试', [{ data: '这是一段话，可能被高亮，也可能不，但是可以试试' }]], ['what is that?', [{ data: 'what is that?' }]]].forEach(function (d) {\n      var data = d[0];\n      it('searchWords.add(' + data + ') should return ' + d[1], function () {\n        _lstoreDbSearch_words2.default.add(data);\n        chai.assert.deepStrictEqual(_lstoreDbSearch_words2.default.select(1), d[1]);\n      });\n    });\n  });\n  describe('@searchWords.select(limit, search, desc)', function () {\n    [[3, undefined, undefined, [{ data: 'what is that?' }, { data: '这是一段话，可能被高亮，也可能不，但是可以试试' }, { data: '03' }]], [2, 'at', undefined, [{ data: 'what is that?', html: ['wh<em>a</em><em>t</em> is th<em>a</em><em>t</em>?'] }]], [2, '可能是', undefined, [{\n      data: '这是一段话，可能被高亮，也可能不，但是可以试试',\n      html: ['这是一段话，<em>可</em><em>能</em>被高亮，也可<em>能</em>不，但<em>是</em>可以试试']\n    }]], [2, undefined, true, [{ data: 'what is that?' }, { data: '这是一段话，可能被高亮，也可能不，但是可以试试' }]], [2, undefined, false, [{ data: '01' }, { data: '02' }]]].forEach(function (d) {\n      var limit = d[0];\n      var search = d[1];\n      var desc = d[2];\n      it('searchWords.select(' + limit + ', ' + search + ', ' + desc + ') should return ' + (0, _jsonFrom2.default)(d[3]), function () {\n        console.log([limit, search, desc], _lstoreDbSearch_words2.default.select(limit, search, desc), d[3]);\n        chai.assert.deepStrictEqual(_lstoreDbSearch_words2.default.select(limit, search, desc), d[3]);\n      });\n    });\n  });\n  describe('@searchWords.delete(data)', function () {\n    it('searchWords.delete(data) should return ' + true, function () {\n      _lstoreDbSearch_words2.default.select(10).forEach(function (d) {\n        return _lstoreDbSearch_words2.default.delete(d.data);\n      });\n      chai.assert.deepStrictEqual(_lstoreDbSearch_words2.default.select(1).length, 0);\n    });\n  });\n});\n\n//# sourceURL=webpack:///./test/store/lstore-db-search_words.test.js?");
