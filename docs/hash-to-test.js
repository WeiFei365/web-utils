...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/native/hash-to.test.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\nvar hashTo = __webpack_require__(/*! ../../src/native/hash-to.js */ \"./src/native/hash-to.js\");\n\ndescribe('native/hash-to', function () {\n  describe('@hashTo(data)', function () {\n    [\n    // 数据合法性\n    [undefined, ''], ['', ''],\n    // --\n    [{}, ''], [{ test: 123 }, 'test=123'], [{ test: { child: 123 } }, 'test=%7B%22child%22%3A123%7D'], [{ test: 123, pms: 'abc' }, 'test=123&pms=abc']].forEach(function (d) {\n      var data = d[0];\n      it('hashTo(' + data + ') should return ' + d[1], function () {\n        chai.assert.strictEqual(hashTo.default(data), d[1]);\n      });\n    });\n  });\n});\n\n//# sourceURL=webpack:///./test/native/hash-to.test.js?");
