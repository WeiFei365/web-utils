...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/number/beauty-number.test.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./test/number/beauty-number.test.js":
/*!*******************************************!*\
  !*** ./test/number/beauty-number.test.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nvar beautyNumber = __webpack_require__(/*! ../../src/number/beauty-number.js */ \"./src/number/beauty-number.js\");\n\ndescribe('number/beauty-number', function () {\n  describe('@beautyNumber(n, noZero)', function () {\n    [\n    // 参数: n\n    [undefined, undefined, '0'], [0, undefined, '0'], [123, undefined, '123'], [123456, undefined, '123,456'], ['123456', undefined, '123,456'], ['1-23456', undefined, '0'], [123456.789, undefined, '123,456.789'],\n    // 参数: n\n    [0, true, ''], [0, false, '0']].forEach(function (d) {\n      var n = d[0];\n      var noZero = d[1];\n      it('beautyNumber(' + n + ', ' + noZero + ') should return ' + d[2], function () {\n        chai.assert.strictEqual(beautyNumber.default(n, noZero), d[2]);\n      });\n    });\n  });\n});\n\n//# sourceURL=webpack:///./test/number/beauty-number.test.js?");
