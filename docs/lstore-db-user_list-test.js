...
/******/ 	return __webpack_require__(__webpack_require__.s = "./test/store/lstore-db-user_list.test.js");
/******/ })
/************************************************************************/
/******/ ({
...
"use strict";
eval("\n\nvar _lstoreDbUser_list = __webpack_require__(/*! ../../src/store/lstore-db-user_list.js */ \"./src/store/lstore-db-user_list.js\");\n\nvar _lstoreDbUser_list2 = _interopRequireDefault(_lstoreDbUser_list);\n\nvar _jsonFrom = __webpack_require__(/*! ../../src/native/json-from.js */ \"./src/native/json-from.js\");\n\nvar _jsonFrom2 = _interopRequireDefault(_jsonFrom);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\ndescribe('store/lstore-db-user_list', function () {\n  describe('@userList.add(data)', function () {\n    [[undefined, []], ['', []], [false, []], [0, []], [{}, []], [{ id: 0 }, []], [{ id: 1 }, []], [{ id: 2, name: '做你想做，想你所想' }, [{ data: { id: '2', name: '做你想做，想你所想' } }]], [{ id: 1, name: 'test' }, [{ data: { id: '1', name: 'test' } }]], [{ id: 123, name: 'abc' }, [{ data: { id: '123', name: 'abc' } }]], [{ id: '123,123', name: 'abc,abc' }, [{ data: { id: '123,123', name: 'abc,abc' } }]], [{ id: 456, name: 'abc456' }, [{ data: { id: '456', name: 'abc456' } }]]].forEach(function (d) {\n      var data = d[0];\n      it('userList.add(' + (0, _jsonFrom2.default)(data) + ') should return ' + (0, _jsonFrom2.default)(_jsonFrom2.default), function () {\n        _lstoreDbUser_list2.default.add(data);\n        chai.assert.deepStrictEqual(_lstoreDbUser_list2.default.select(1), d[1]);\n      });\n    });\n  });\n  describe('@userList.select(limit, search, desc)', function () {\n    [[3, undefined, undefined, [{ data: { id: '456', name: 'abc456' } }, { data: { id: '123,123', name: 'abc,abc' } }, { data: { id: '123', name: 'abc' } }]], [2, 'et', undefined, [{\n      data: { id: '1', name: 'test' },\n      html: ['t<em>e</em>s<em>t</em>', '1']\n    }]], [2, '4', undefined, [{\n      data: { id: '456', name: 'abc456' },\n      html: ['abc<em>4</em>56', '<em>4</em>56']\n    }]], [4, '23', undefined, [{\n      data: { id: '123,123', name: 'abc,abc' },\n      html: ['abc,abc', '1<em>2</em><em>3</em>,1<em>2</em><em>3</em>']\n    }, {\n      data: { id: '123', name: 'abc' },\n      html: ['abc', '1<em>2</em><em>3</em>']\n    }]], [2, '你想', undefined, [{\n      data: { id: '2', name: '做你想做，想你所想' },\n      html: ['做<em>你</em><em>想</em>做，想<em>你</em>所<em>想</em>', '2']\n    }]], [2, undefined, true, [{ data: { id: '456', name: 'abc456' } }, { data: { id: '123,123', name: 'abc,abc' } }]], [2, undefined, false, [{ data: { id: '2', name: '做你想做，想你所想' } }, { data: { id: '1', name: 'test' } }]]].forEach(function (d) {\n      var limit = d[0];\n      var search = d[1];\n      var desc = d[2];\n      it('userList.select(' + limit + ', ' + search + ', ' + desc + ') should return ' + (0, _jsonFrom2.default)(d[3]), function () {\n        chai.assert.deepStrictEqual(_lstoreDbUser_list2.default.select(limit, search, desc), d[3]);\n      });\n    });\n  });\n  describe('@userList.delete(data)', function () {\n    it('userList.delete(data) should return ' + true, function () {\n      _lstoreDbUser_list2.default.select(10).forEach(function (d) {\n        return _lstoreDbUser_list2.default.delete(d.data);\n      });\n      chai.assert.deepStrictEqual(_lstoreDbUser_list2.default.select(1).length, 0);\n    });\n  });\n});\n\n//# sourceURL=webpack:///./test/store/lstore-db-user_list.test.js?");
